...
const PRICING_PLANS_DATA: PricingPlanData[] = [
  ...
  },
  {
    ...
    description: {
      fr: 'Pour les projets complexes : logiciels métier, applications mobiles, ERP et solutions clé en main.',
      en: 'For complex projects: business software, mobile apps, ERP and turnkey solutions.',
    },
    features: {
      fr: [
